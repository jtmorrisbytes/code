...
pub mod types {
    ...
    pub type __GLXFBConfigRec = *mut GLXFBConfig;
...
impl Glx {
    ...
    pub unsafe fn ChooseFBConfig(
        ...
        attrib_list: *const __gl_imports::raw::c_int,
        nelements: *mut __gl_imports::raw::c_int,
    ) -> *mut types::GLXFBConfig {
        __gl_imports::mem::transmute::<
            _,
            extern "system" fn(
                *mut types::Display,
                __gl_imports::raw::c_int,
                *const __gl_imports::raw::c_int,
                *mut __gl_imports::raw::c_int,
            ) -> *mut types::GLXFBConfig,
        >(self.ChooseFBConfig.f)(dpy, screen, attrib_list, nelements)
    }
    #[allow(non_snake_case, unused_variables, dead_code)]
    #[inline]
    ...
    pub unsafe fn CreateNewContext(
        &self,
        dpy: *mut types::Display,
        config: types::GLXFBConfig,
        render_type: __gl_imports::raw::c_int,
        share_list: types::GLXContext,
        direct: types::Bool,
    ) -> types::GLXContext {
        __gl_imports::mem::transmute::<
            _,
        ...
        >(self.CreateNewContext.f)(dpy, config, render_type, share_list, direct)
    }
    #[allow(non_snake_case, unused_variables, dead_code)]
    #[inline]
    pub unsafe fn CreatePbuffer(
        ...
        >(self.CreatePbuffer.f)(dpy, config, attrib_list)
    }
    #[allow(non_snake_case, unused_variables, dead_code)]
    #[inline]
    pub unsafe fn CreatePixmap(
        ...
        >(self.CreatePixmap.f)(dpy, config, pixmap, attrib_list)
    }
    #[allow(non_snake_case, unused_variables, dead_code)]
    #[inline]
    pub unsafe fn CreateWindow(
        ...
        >(self.CreateWindow.f)(dpy, config, win, attrib_list)
    }
    #[allow(non_snake_case, unused_variables, dead_code)]
    #[inline]
    ...
    #[allow(non_snake_case, unused_variables, dead_code)]
    #[inline]
    pub unsafe fn DestroyPbuffer(&self, dpy: *mut types::Display, pbuf: types::GLXPbuffer) -> () {
        __gl_imports::mem::transmute::<
            _,
            extern "system" fn(*mut types::Display, types::GLXPbuffer) -> (),
        >(self.DestroyPbuffer.f)(dpy, pbuf)
    }
    #[allow(non_snake_case, unused_variables, dead_code)]
    #[inline]
    pub unsafe fn DestroyPixmap(&self, dpy: *mut types::Display, pixmap: types::GLXPixmap) -> () {
        __gl_imports::mem::transmute::<
            _,
            extern "system" fn(*mut types::Display, types::GLXPixmap) -> (),
        >(self.DestroyPixmap.f)(dpy, pixmap)
    }
    #[allow(non_snake_case, unused_variables, dead_code)]
    #[inline]
    pub unsafe fn DestroyWindow(&self, dpy: *mut types::Display, win: types::GLXWindow) -> () {
        __gl_imports::mem::transmute::<
            _,
            extern "system" fn(*mut types::Display, types::GLXWindow) -> (),
        >(self.DestroyWindow.f)(dpy, win)
    }
    #[allow(non_snake_case, unused_variables, dead_code)]
    #[inline]
    pub unsafe fn GetClientString(
        ...
        >(self.GetClientString.f)(dpy, name)
    }
    #[allow(non_snake_case, unused_variables, dead_code)]
    #[inline]
    ...
    #[allow(non_snake_case, unused_variables, dead_code)]
    #[inline]
    pub unsafe fn GetCurrentDisplay(&self) -> *mut types::Display {
        __gl_imports::mem::transmute::<_, extern "system" fn() -> *mut types::Display>(
            self.GetCurrentDisplay.f,
        )()
    }
    #[allow(non_snake_case, unused_variables, dead_code)]
    #[inline]
    ...
    #[allow(non_snake_case, unused_variables, dead_code)]
    #[inline]
    pub unsafe fn GetCurrentReadDrawable(&self) -> types::GLXDrawable {
        __gl_imports::mem::transmute::<_, extern "system" fn() -> types::GLXDrawable>(
            self.GetCurrentReadDrawable.f,
        )()
    }
    #[allow(non_snake_case, unused_variables, dead_code)]
    #[inline]
    pub unsafe fn GetFBConfigAttrib(
        ...
        dpy: *mut types::Display,
        config: types::GLXFBConfig,
        attribute: __gl_imports::raw::c_int,
        value: *mut __gl_imports::raw::c_int,
    ) -> __gl_imports::raw::c_int {
        __gl_imports::mem::transmute::<
            _,
        ...
        >(self.GetFBConfigAttrib.f)(dpy, config, attribute, value)
    }
    #[allow(non_snake_case, unused_variables, dead_code)]
    #[inline]
    pub unsafe fn GetFBConfigs(
        ...
        >(self.GetFBConfigs.f)(dpy, screen, nelements)
    }
    #[allow(non_snake_case, unused_variables, dead_code)]
    #[inline]
    pub unsafe fn GetProcAddress(&self, procName: *const types::GLubyte) -> types::__GLXextFuncPtr {
        __gl_imports::mem::transmute::<
            _,
            extern "system" fn(*const types::GLubyte) -> types::__GLXextFuncPtr,
        >(self.GetProcAddress.f)(procName)
    }
    #[allow(non_snake_case, unused_variables, dead_code)]
    #[inline]
    pub unsafe fn GetSelectedEvent(
        &self,
        dpy: *mut types::Display,
        draw: types::GLXDrawable,
        event_mask: *mut __gl_imports::raw::c_ulong,
    ) -> () {
        __gl_imports::mem::transmute::<
            _,
            extern "system" fn(
                *mut types::Display,
                types::GLXDrawable,
                *mut __gl_imports::raw::c_ulong,
            ) -> (),
        >(self.GetSelectedEvent.f)(dpy, draw, event_mask)
    }
    #[allow(non_snake_case, unused_variables, dead_code)]
    #[inline]
    pub unsafe fn GetVisualFromFBConfig(
        ...
        __gl_imports::mem::transmute::<
            _,
            extern "system" fn(*mut types::Display, types::GLXFBConfig) -> *mut types::XVisualInfo,
        >(self.GetVisualFromFBConfig.f)(dpy, config)
    }
    #[allow(non_snake_case, unused_variables, dead_code)]
    #[inline]
    ...
    pub unsafe fn MakeContextCurrent(
        ...
        >(self.MakeContextCurrent.f)(dpy, draw, read, ctx)
    }
    #[allow(non_snake_case, unused_variables, dead_code)]
    #[inline]
    ...
    pub unsafe fn QueryContext(
        ...
        >(self.QueryContext.f)(dpy, ctx, attribute, value)
    }
    #[allow(non_snake_case, unused_variables, dead_code)]
    #[inline]
    pub unsafe fn QueryDrawable(
        ...
        draw: types::GLXDrawable,
        attribute: __gl_imports::raw::c_int,
        value: *mut __gl_imports::raw::c_uint,
    ) -> () {
        __gl_imports::mem::transmute::<
            _,
            extern "system" fn(
    ...
    pub unsafe fn QueryExtensionsString(
        ...
        >(self.QueryExtensionsString.f)(dpy, screen)
    }
    #[allow(non_snake_case, unused_variables, dead_code)]
    #[inline]
    pub unsafe fn QueryServerString(
        ...
        >(self.QueryServerString.f)(dpy, screen, name)
    }
    #[allow(non_snake_case, unused_variables, dead_code)]
    #[inline]
    ...
    pub unsafe fn SelectEvent(
        ...
        dpy: *mut types::Display,
        draw: types::GLXDrawable,
        event_mask: __gl_imports::raw::c_ulong,
    ) -> () {
        __gl_imports::mem::transmute::<
            _,
            extern "system" fn(
        ...
        >(self.SelectEvent.f)(dpy, draw, event_mask)
    }
    #[allow(non_snake_case, unused_variables, dead_code)]
    #[inline]
