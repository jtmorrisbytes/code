...
pub const XNRequiredCharSet: &::std::ffi::CStr = c"requiredCharSet";
pub const XNQueryOrientation: &::std::ffi::CStr = c"queryOrientation";
pub const XNBaseFontName: &::std::ffi::CStr = c"baseFontName";
pub const XNOMAutomatic: &::std::ffi::CStr = c"omAutomatic";
pub const XNMissingCharSet: &::std::ffi::CStr = c"missingCharSet";
pub const XNDefaultString: &::std::ffi::CStr = c"defaultString";
pub const XNOrientation: &::std::ffi::CStr = c"orientation";
pub const XNDirectionalDependentDrawing: &::std::ffi::CStr = c"directionalDependentDrawing";
pub const XNContextualDrawing: &::std::ffi::CStr = c"contextualDrawing";
pub const XNFontInfo: &::std::ffi::CStr = c"fontInfo";
...
pub const XNResourceName: &::std::ffi::CStr = c"resourceName";
pub const XNResourceClass: &::std::ffi::CStr = c"resourceClass";
pub const XNGeometryCallback: &::std::ffi::CStr = c"geometryCallback";
...
pub const XNPreeditStateNotifyCallback: &::std::ffi::CStr = c"preeditStateNotifyCallback";
pub const XNPreeditAttributes: &::std::ffi::CStr = c"preeditAttributes";
pub const XNStatusStartCallback: &::std::ffi::CStr = c"statusStartCallback";
pub const XNStatusDoneCallback: &::std::ffi::CStr = c"statusDoneCallback";
pub const XNStatusDrawCallback: &::std::ffi::CStr = c"statusDrawCallback";
pub const XNStatusAttributes: &::std::ffi::CStr = c"statusAttributes";
pub const XNArea: &::std::ffi::CStr = c"area";
pub const XNAreaNeeded: &::std::ffi::CStr = c"areaNeeded";
pub const XNSpotLocation: &::std::ffi::CStr = c"spotLocation";
pub const XNColormap: &::std::ffi::CStr = c"colorMap";
pub const XNStdColormap: &::std::ffi::CStr = c"stdColorMap";
pub const XNForeground: &::std::ffi::CStr = c"foreground";
pub const XNBackground: &::std::ffi::CStr = c"background";
pub const XNBackgroundPixmap: &::std::ffi::CStr = c"backgroundPixmap";
pub const XNFontSet: &::std::ffi::CStr = c"fontSet";
pub const XNLineSpace: &::std::ffi::CStr = c"lineSpace";
pub const XNCursor: &::std::ffi::CStr = c"cursor";
pub const XNQueryIMValuesList: &::std::ffi::CStr = c"queryIMValuesList";
pub const XNQueryICValuesList: &::std::ffi::CStr = c"queryICValuesList";
pub const XNVisiblePosition: &::std::ffi::CStr = c"visiblePosition";
pub const XNR6PreeditCallback: &::std::ffi::CStr = c"r6PreeditCallback";
pub const XNStringConversionCallback: &::std::ffi::CStr = c"stringConversionCallback";
pub const XNStringConversion: &::std::ffi::CStr = c"stringConversion";
pub const XNResetState: &::std::ffi::CStr = c"resetState";
pub const XNHotKey: &::std::ffi::CStr = c"hotKey";
pub const XNHotKeyState: &::std::ffi::CStr = c"hotKeyState";
pub const XNPreeditState: &::std::ffi::CStr = c"preeditState";
pub const XNSeparatorofNestedList: &::std::ffi::CStr = c"separatorofNestedList";
